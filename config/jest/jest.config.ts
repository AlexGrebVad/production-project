...
export default {
  ...
  // A path to a module which exports an async function t
  // hat is triggered once before all test suites
  ...
  //  10% will use 10% of your CPU amount + 1 as the maxi
  // mum worker number. maxWorkers: 2 will use a maximum of 2 workers.
  // maxWorkers: "50%",
  ...
  // A map from regular expressions to module names or t
  // o arrays of module names that allow to stub out resources with a single module
  // moduleNameMapper: {},
